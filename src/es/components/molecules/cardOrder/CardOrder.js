...
export default class CardOrder extends Shadow() {
  constructor (options = {}, ...args) {
    ...
    this.downloadUrl = this.getAttribute('downloadUrl')
    this.duplicateText = this.getAttribute('duplicateText')
    this.duplicateUrl = this.getAttribute('duplicateUrl')
  }
  ...
  renderHTML () {
    const buttonEdit = this.editText
      ...
      : ''
    const buttonDownload = this.downloadText
      ? `
        <a-button namespace="button-action-"  href="${this.downloadUrl}">
            ${this.downloadText}
      ...
      : ''
    const buttonDuplicate = this.duplicateText
      ? `
        <a-button namespace="button-action-" href="${this.duplicateUrl}">
            ${this.duplicateText}
